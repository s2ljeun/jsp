...
<!-- prod_input.jsp -->
<%	
		List<CategoryDTO> list = (List)request.getAttribute("cateList");
		if (list == null || list.size()==0){%>
		<script type="text/javascript">
			alert("카테고리를 먼저 등록해 주세요!!")
			location.href="shop_mall.do"
		</script>
<%		return;
		} %>		
...
<div align="center">
	<form name="f" action="prod_input_ok.mall" method="post" enctype="multipart/form-data">
